...
contract OFINToken is ERC20, ERC20Capped, ERC20Pausable, ERC20Burnable, AccessControl {
    ...
    function mint(address to, uint256 amount) public virtual {
        ...
        if (to == _msgSender()) {
            require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "OFINToken: must have admin role to mint to self");
        }
        _mint(to, amount);
    }
...
// File: contracts/OFINAllotment.sol
...
*/
 contract OFINAllotment is AccessControl {
    ...
    mapping( address => address[] ) beneficiaryAllotments;
